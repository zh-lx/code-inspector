...
declare const MESSAGES: {
    ...
    readonly 'chat.terminalEndedTitle': {
        readonly en: "Session ended";
        readonly zh: "会话已结束";
    };
    readonly 'chat.terminalRestart': {
        readonly en: "Restart";
        readonly zh: "重新开始";
    };
    readonly 'chat.terminalClose': {
        readonly en: "Close";
        readonly zh: "关闭";
    };
...
type ExtractTemplateVars<S extends string> = S extends `${string}{${infer Name}}${infer Rest}` ? Name | ExtractTemplateVars<Rest> : never;
type MessageTemplateVars<K extends ClientTextKey> = ExtractTemplateVars<(typeof MESSAGES)[K]['en'] | (typeof MESSAGES)[K]['zh']>;
type TemplateVars<K extends ClientTextKey> = [MessageTemplateVars<K>] extends [
    never
] ? Record<string, never> : Record<MessageTemplateVars<K>, TemplateValue>;
...
export declare function getClientText<K extends ClientTextKey>(lang: string | null | undefined, key: K, vars?: ClientTextVars<K>): string;
